document.addEventListener('DOMContentLoaded', async () => {
    // Fungsi formatRp, formatRupiah, dan bersihAngka dipanggil dari utils.js
    ...
    try {
        ...
        if (result.success) {
            ...
            document.getElementById('uh_satuan').value = formatRupiah(Math.round(Number(d.uang_harian_satuan) || 0).toString());
            ...
            document.getElementById('tr_satuan').value = formatRupiah(Math.round(Number(d.transport_satuan) || 0).toString());

            // Isi Rincian Penginapan
            document.getElementById('inn_vol').value = d.penginapan_vol || 0;
            document.getElementById('inn_satuan').value = formatRupiah(Math.round(Number(d.penginapan_satuan) || 0).toString());
